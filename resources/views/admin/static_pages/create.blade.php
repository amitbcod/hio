...
<div class="container">
    ...
    <form action="{{ route('admin.static-pages.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="slug" class="form-control" placeholder="Optional, auto-generated from title">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="content_en" id="content_en" class="form-control" rows="10" style="display:none;"></textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="content_fr" id="content_fr" class="form-control" rows="10" style="display:none;"></textarea>
