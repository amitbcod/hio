...
@php $sidebar = 'admin.groups._steps_sidebar'; $currentStep = 6; @endphp
...
<div class="container mt-4 mb-5">
    ...
    <form method="POST" action="{{ route('admin.groups.step6.store', $group->id) }}">
        @csrf
        ...
        <div class="card border-0 shadow-sm" style="border-radius:14px; overflow:hidden;">
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('admin.groups.step5', $group->id) }}" class="btn btn-outline-secondary">Back</a>
                    <div>
