...
@php $sidebar = 'admin.groups._steps_sidebar'; $currentStep = 3; @endphp
...
<div class="container mt-5">
    ...
    <form method="POST" action="{{ route('admin.groups.step3.store', $group->id) }}">
        @csrf
        ...
        <div style="background:#fff;border-radius:12px;padding:20px;box-shadow:0 2px 12px rgba(0,0,0,0.04);">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;">
                <a href="{{ route('admin.groups.step2', $group->id) }}" class="btn btn-light">Back</a>
