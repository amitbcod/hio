...
@php $sidebar = 'admin.groups._steps_sidebar'; $currentStep = 5; @endphp
...
<div class="container mt-4 mb-5">
    <div class="card border-0 shadow-sm mb-4" style="border-radius:14px; overflow:hidden;">
        <div class="card-body p-4">
            ...
            <p class="mb-0 text-muted">Add descriptive content, terms and SEO details for this group</p>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.groups.step5.store', $group->id) }}" enctype="multipart/form-data">
        @csrf
        @php
            $c = $content ?? [];
        @endphp
        ...
        <div class="card border-0 shadow-sm" style="border-radius:14px; overflow:hidden;">
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="full_description" rows="6" class="form-control" placeholder="Detailed description of the group, highlights and experience">{{ old('full_description', $c['full_description'] ?? '') }}</textarea>
                </div>
                ...
                <p class="text-muted small">Click to upload or drag and drop group images PNG, JPG up to 5MB each</p>
                ...
                <div class="mb-3 row g-2 align-items-center">
                    <div class="col-md-9">
                        ...
                        <input type="text" name="og_image_url" class="form-control" value="{{ old('og_image_url', $c['og_image_url'] ?? '') }}" placeholder="e.g., https://example.com/images/group-og.jpg">
                    </div>
                    <div class="col-md-3">
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('admin.groups.step4', $group->id) }}" class="btn btn-outline-secondary">Back</a>
                    <div>
