                ...
                <div class="container-middle">
                    ...
                    <div class="properties-section" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 32px;">
                        ...
                        <div class="book-section" style="display: flex; gap: 12px;">
                            <a href="{{ route('admin.accommodation.bookings') }}" class="btn btn-secondary d-flex align-items-center">
                                📅 View Bookings
                            </a>
                            <a href="{{ route('admin.accommodation.create') }}" class="btn btn-primary d-flex align-items-center">
                                + Add New Property
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div style="padding: 16px;">
                                            ...
                                            <div style="margin-bottom: 16px;">
                                                ...
                                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 11px;">
                                                    <div style="background: {{ $accommodation->step1_basics ? '#d3e1eb' : '#ffebee' }}; padding: 8px; border-radius: 4px; text-align: center;">
                                                        {{ $accommodation->step1_basics ? '✓' : '○' }} Basics
                                                    </div>
                                                    <div style="background: {{ $accommodation->step2_legal ? '#d3e1eb' : '#ffebee' }}; padding: 8px; border-radius: 4px; text-align: center;">
                                                        {{ $accommodation->step2_legal ? '✓' : '○' }} Legal
                                                    </div>
                                                    <div style="background: {{ $accommodation->step3_media ? '#d3e1eb' : '#ffebee' }}; padding: 8px; border-radius: 4px; text-align: center;">
                                                        {{ $accommodation->step3_media ? '✓' : '○' }} Media
                                                    </div>
                                                    <div style="background: {{ $accommodation->step4_rooms ? '#d3e1eb' : '#ffebee' }}; padding: 8px; border-radius: 4px; text-align: center;">
                                                        {{ $accommodation->step4_rooms ? '✓' : '○' }} Rooms
                                                    </div>
                                                    <div style="background: {{ $accommodation->step5_rates ? '#d3e1eb' : '#ffebee' }}; padding: 8px; border-radius: 4px; text-align: center;">
                                                        {{ $accommodation->step5_rates ? '✓' : '○' }} Rates
                                                    </div>
                                                    <div style="background: {{ $accommodation->step6_policies ? '#d3e1eb' : '#ffebee' }}; padding: 8px; border-radius: 4px; text-align: center;">
                                            ...
                                            <div style="display: flex; gap: 8px;">
                                                <a href="{{ route('admin.accommodation.show', $accommodation->id) }}" class="btn btn-secondary" style="">
                                                    Continue Setup
                                                </a>
                                                <a href="{{ route('admin.accommodation.step1.edit', $accommodation->id) }}" class="btn btn-primary" style="">
                                                    Edit Basics
                                                </a>
                                            </div>
                                        </div>
