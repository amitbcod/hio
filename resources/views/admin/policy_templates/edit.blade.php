...
@section('content')
<div class="container">
    <h3>Edit Policy Template</h3>
    <form action="{{ route('admin.policy-templates.update', $template) }}" method="POST">
        @csrf
        @include('admin.policy_templates._form', ['template' => $template, 'service' => $template->service_type])
