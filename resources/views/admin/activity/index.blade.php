        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div style="background:#fff;border-radius:16px;padding:20px;box-shadow:0 2px 16px rgba(0,0,0,0.07);margin-bottom:20px;display:flex;justify-content:space-between;align-items:center;">
                    ...
                    <a href="{{ route('admin.activity.create') }}" style="background:#19b5b5;color:#fff;padding:10px 20px;border-radius:4px;text-decoration:none;font-size:14px;font-weight:600;">
                        + Create New Activity
                    </a>
                </div>
