        ...
        <div class="card-body">
            ...
            @if(isset($owner) && $owner)
                <div class="alert alert-info">
                    ...
                    <p>Please <a href="{{ route('mpo.login') }}">login</a> with that account to approve this verification request.</p>
                </div>

                <form method="POST" action="{{ url('/mpo/register/controller/verify/'.$cv->token.'/accept') }}">
                    @csrf
            ...
            @else
                ...
                <p>You can claim and create an owner account below. We will not ask you to re-enter business details.</p>
                ...
                <form method="POST" action="{{ url('/mpo/register/controller/verify/'.$cv->token.'/claim') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select name="agreement_type" class="form-control" required>
                            ...
                            <option value="Widget Only">Widget Only</option>
                            <option value="OTO + Widget">OTO + Widget</option>
