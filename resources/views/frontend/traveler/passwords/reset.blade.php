...
@section('title', 'Reset Password | Holidays.io')
@section('meta_description', 'Set a new password for your Holidays.io traveler account.')
        ...
        <div class="wrap">
            <div class="traveler-login-card">
                <div class="traveler-auth-head">
                    ...
                    <p>Enter a new password to restore access to your account.</p>
                </div>
                ...
                <form method="POST" action="{{ route('traveler.password.update') }}" class="traveler-login-form">
                    @csrf
                    ...
                    <button type="submit" class="btn-primary traveler-login-btn">Reset Password</button>
                </form>

                <p class="traveler-inline-note">
                    Back to <a href="{{ route('traveler.login') }}">Sign in</a>
                </p>
            </div>
        </div>
    </section>
