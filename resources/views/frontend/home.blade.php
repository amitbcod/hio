    ...
    <section class="page-section">
        <div class="wrap split-highlight">
            <div class="highlight-copy">
                ...
                <p>
                    Mauritius is more than just a destination — it is now a dynamic homepage connected to your real operator entries.
                    Accommodation and activity content below is loaded from your existing database so the public frontend starts feeling alive
            ...
            <div class="highlight-card">
                <img src="{{ $heroSlides[0]['image'] ?? asset('images/holidays-io-logo.png') }}" alt="Featured Mauritius experience">
            </div>
        </div>
    </section>
        ...
        <div class="wrap">
            ...
            <div class="tabs-shell">
                            ...
                            @foreach($activities as $activity)
                                <article class="listing-card">
                                    ...
                                    <div class="listing-body">
                                        <span class="listing-location"><i class="fa-solid fa-location-dot"></i> {{ $activity['location'] }}</span>
                        ...
                        <div class="cards-grid">
                            @foreach($holidayRentals as $accommodation)
                                <article class="listing-card">
                                    ...
                                    <div class="listing-body">
                                        <span class="listing-location"><i class="fa-solid fa-location-dot"></i> {{ $accommodation['location'] }}</span>
                ...
                <div class="tab-panel" data-tab-panel="services">
                    <div class="empty-state">Frontend service cards are ready to be connected when service data becomes available.</div>
                </div>
                <div class="tab-panel" data-tab-panel="transport">
                    <div class="empty-state">Frontend transport cards are ready to be connected when transport data becomes available.</div>
                </div>
                <div class="tab-panel" data-tab-panel="wedding">
                    <div class="empty-state">Frontend wedding cards are ready to be connected when wedding data becomes available.</div>
                </div>
            </div>
        </div>
    </section>
