...
$app->get('/webshop/get_custom_variable/{identifier}', function (Request $request, Response $response, $args) {
	...
	if ($identifier == '') {
		...
		$get_custom_variable = $webshop_obj->get_custom_variable($identifier);
