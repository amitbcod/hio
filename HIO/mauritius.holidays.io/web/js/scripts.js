(function ($) {
	...
	var bookyourtravel = {
		init: function () {
			...
			$('.find_search_class').change(function () {
				var showForm = $(this).val();
			...
			// 	dateFormat: 'dd-mm-yy',
			// 	showOn: 'button',
			// 	buttonImage: SITEURL + '/public/web/images/ico/calendar.png',
			// 	buttonImageOnly: true
			// });
			var siteUrl = SITEURL + '/public/web/images/ico/calendar.png';
			$('.datepicker2').datepicker({
				dateFormat: 'dd-mm-yy',
				showOn: 'both', // 🔁 Opens on both field and icon click
				buttonImage: SITEURL + '/public/web/images/ico/calendar.png',
				buttonImageOnly: true,
			...
			$('.datepicker1').datepicker({
				...
				onSelect: function (selectedDate) {
					...
					// Set minDate for checkout datepicker
		...
		load: function () {
			...
			if (jQuery('#check_radio_button').val() != "" && href.match(/([^\/]*)\/*$/)[1] != 'tour_search') {
				//jQuery('#uniform-hotel').find('span').removeClass('checked');
				//jQuery('#form1').hide();
				//jQuery('#form2').show();
			}
			/* if(jQuery('#check_radio_button').val() == "1"){
				jQuery('#uniform-hotel').find('span').removeClass('checked');
				jQuery('#form1').show();
				jQuery('#form2').hide();
			} */
