	...
	$("#product-frm-edit").validate({
        ...
        messages: {
			...
			stock_qty: {
				...
				remote: "Please enter number greater than "+$('#stock_qty').data('ordered_qty')
			},
			sku: {
				//required: "Please enter valid sku.",
...
function SaveExistingProduct()
{
    ...
    if(product_name_lang==""){
        ...
        return false;
            ...
            data: {meta_description_lang:meta_description_lang,hidden_product_id:hidden_product_id,
	               code:code,product_name_lang:product_name_lang,description_lang:description_lang,highlights_lang:highlights_lang,
	               meta_keyword_lang:meta_keyword_lang,meta_title_lang:meta_title_lang},
            success: function(response) {
                console.log(response);
                if(response.flag == 1)
                    {
...
function SaveProductMediaByAttr()
{
	// var attr_id = [];
	// var all_attr_id= [];
	// $("input[name='attr_option[]']").each(function(){
	// 	//alert($(this).val());
	// 	var all_attr_id = $(this).val();
	// 	attr_id.push($(this).val());
	// 	//var media_attr_id = [];
	// 	var media_attr_id = [];
	// 	var value = "media_attr_" + all_attr_id +"[]";
	// 	//alert(value);
	// 	$("input[name='"+value+"']:checked").each(function(){
	// 	    media_attr_id.push($(this).val());
	// 	});
	// 	let variant = media_attr_id + all_attr_id;
	// });
