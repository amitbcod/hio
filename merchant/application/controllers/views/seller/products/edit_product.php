	...
	<input type="hidden" value="<?php echo $ProductData->id; ?>" id="pid" name="pid">
		...
		<div class="row">
				<div class="col-md-6">
					...
					<div class="col-sm-12"><input type="text" class="form-control" name="product_name" value="<?php  echo $ProductData->name; ?>" id="product_name" placeholder="Product Name" readonly="true">
					</div>

					<div class="col-sm-12"><input type="text" class="form-control" name="product_code" id="product_code"  value="<?php  echo $ProductData->product_code; ?>" placeholder="Product Code *" readonly="true">
					</div>
					...
					<textarea class="form-control" id="description" name="description" readonly="true"><?php echo (isset($ProductData->description) && $ProductData->description!='')?$ProductData->description:''; ?></textarea>
					</div>
				</div>
		<!-- col-md-6 -->
		...
		<div class="col-md-6">
			...
			<div class="col-sm-12"><textarea class="form-control product-highlight-textarea" id="highlights"  name="highlights"  readonly="true"><?php echo (isset($ProductData->highlights) && $ProductData->highlights!='')?$ProductData->highlights:''; ?></textarea>
			</div>
			...
			<div class="container col-sm-12">
  				<form>
    				<label class="radio-inline">
      					<input type="radio" name="type-of-commission" <?php echo ($ProductData->pub_com_per_type == 0) ? 'checked' : '' ?> value="0" disabled>Publisher Commission
						  <span class="checkmark" ></span></label>
    				<label class="radio-inline">
      					<input type="radio" name="type-of-commission" <?php echo ($ProductData->pub_com_per_type == 1) ? 'checked' : '' ?> value="1" disabled>Product Commission
						  <span class="checkmark" ></span></label>
  				</form>
			</div>
			...
			<div class="col-sm-12">
			<h2>Publisher Commission Percentage</h2>
			<input type="text" class="form-control" name="pub_com_percentage" id="pub_com_percentage" placeholder="Publisher Commission Percentage" value="<?php echo (isset($ProductData->pub_com_percent) && $ProductData->pub_com_percent!='')?$ProductData->pub_com_percent:''; ?>" readonly = "true">
			</div>

			<div class="col-sm-12">
			<h2>Product Review Code</h2>
			<input type="text" class="form-control" name="product_reviews_code" id="product_reviews_code" placeholder="Product Review Code"  value="<?php echo (isset($ProductData->product_reviews_code) && $ProductData->product_reviews_code!='')?$ProductData->product_reviews_code:''; ?>" readonly = "true">
			</div>


			<div class="col-sm-12">
			<h2>Launch Date</h2>
			<input type="text" class="form-control" id="launch_date" name="launch_date" readonly placeholder="Launch Date" value="<?php echo (isset($ProductData->launch_date) && $ProductData->launch_date!='0')?date('d-m-Y',$ProductData->launch_date):''; ?>" readonly="true">
			</div>

			<div class="col-sm-12">
			<h2>Meta Title</h2>
			<input type="text" class="form-control" name="meta_title" id="meta_title" placeholder="" value="<?php echo (isset($ProductData->meta_title) && $ProductData->meta_title!='')?$ProductData->meta_title:''; ?>" readonly = "true">
			</div>
			<div class="col-sm-12">
			<h2>Meta Keyword</h2>
			<input type="text" class="form-control" name="meta_keyword" id="meta_keyword" placeholder="" readonly = "true" value="<?php echo (isset($ProductData->meta_keyword) && $ProductData->meta_keyword!='')?$ProductData->meta_keyword:''; ?>">
			</div>


			<div class="col-sm-12"><h2>Meta Description</h2><textarea class="form-control product-highlight-textarea " id="meta_description"  name="meta_description" readonly = "true"><?php echo (isset($ProductData->meta_description) && $ProductData->meta_description!='')?$ProductData->meta_description:''; ?></textarea></div>

			<div class="col-sm-12">
			<h2>Search Keywords</h2>
			<input type="text" class="form-control" name="search_keywords" id="search_keywords" value="<?php echo (isset($ProductData->search_keywords) && $ProductData->search_keywords!='')?$ProductData->search_keywords:''; ?>" placeholder="" readonly = "true">
			</div>
			<div class="col-sm-12">
			<h2>Promo Reference</h2>
			<input type="text" class="form-control" name="promo_reference" id="promo_reference" value="<?php echo (isset($ProductData->promo_reference) && $ProductData->promo_reference!='')?$ProductData->promo_reference:''; ?>" placeholder="" readonly = "true">
			</div>
            ...
            <div class="col-sm-12">
                    ...
                    <div class="radio">
                        <label>
							<input type="radio" name="status" <?php echo (isset($ProductData->status) && $ProductData->status =='1')?'checked':''; ?> value="1" disabled>
							Enabled 
                    ...
                    <div class="radio">
                        <label>
							<input type="radio" name="status"  <?php echo (isset($ProductData->status) && $ProductData->status =='2')?'checked':''; ?> value="2" disabled>
			...
			<div class="col-sm-12">
             	<div class="radio">
                     <label><input type="radio" name="coming-product" <?php echo (isset($ProductData->coming_soon_flag) && $ProductData->coming_soon_flag=='0')?'checked':''; ?> value="0" disabled>No<span class="checkmark" ></span></label>
                </div>
				<div class="radio">
					<label><input type="radio" name="coming-product" <?php echo (isset($ProductData->coming_soon_flag) && $ProductData->coming_soon_flag=='1')?'checked':''; ?> value="1" disabled>Yes <span class="checkmark" ></span></label>
				</div>
			</div>
		...
		<div class="col-sm-12">
		 ...
		 <div class="col-md-6">
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" id="estimate_delivery_time" name="estimate_delivery_time" placeholder="Estimate Delivery Time" value="<?php echo (isset($ProductData->estimate_delivery_time) && $ProductData->estimate_delivery_time!='')?$ProductData->estimate_delivery_time:''; ?>" readonly="true"><span class="days-span">Weeks</span>
                </div>

                <div class="col-sm-12 d-none">
                    <label>Product Return Duration</label>
                    <input type="text" class="form-control" id="product_return_time"  name="product_return_time" onkeypress="return isNumberKey(event);" placeholder="Product Return Time"  value="<?php if(isset($product_return_duration)) { echo $product_return_duration->value ; } ?>" readonly="true"><span class="days-span">Days</span>
                </div>
				...
				<div class="col-md-12 ">
					...
					?>
						...
						<table class="table table-bordered table-style <?php if($bundleCalculationDisplay!='Yes'){ echo 'd-none';} ?>" id="bundleTotal">
							<tr><td ><b>Bundle Selling Price</b></td><td ><input type="number" name="bundle_price" id="bundle_price" onload="calculate_bundle_webshop_selling_price(<?=$Rounded_price_flag?>);" value="<?php if(isset($ProductData->price)){ echo $ProductData->price;} ?>"></td></tr>
							<tr><td ><b>Bundle Webshop Price</b></td><td ><input type="number" name="bundle_webshopprice" id="bundle_webshop_price" onload="calculate_bundle_webshop_selling_price(<?=$Rounded_price_flag?>);" value="<?php if(isset($ProductData->webshop_price)){ echo $ProductData->webshop_price;} ?>"></td></tr>
			...
			<table class="table table-bordered table-style">
                  ...
                  <tbody>
					...
					<td><input type="text" class="form-control input-sm " name="sku" id="sku" value="<?php echo $ProductData->sku; ?>" ></td>
					  ...
					  <td><input type="number" class="form-control input-sm" onkeypress="return isNumberKey(event);" readonly name="webshop_price" id="webshop_price" value="<?php echo $ProductData->webshop_price; ?>"></td>
