	...
	<tr id="variant_row_<?php echo $random_id; ?>"  class="vr-row">
      ...
      $giftsTo = $this->SellerProductModel->get_gifts_data();
		...
		<?php
		  ...
		  <td><input type="number" class="form-control required-field webshop-price" onkeypress="return isNumberKey(event);" name="variant_webshop_price[]" readonly   id="variant_webshop_price_<?php echo $random_id; ?>"></td>
