	...
	foreach($VariantProducts as $variant){
			...
			<?php
					...
					?>
					 ...
					 <select name="<?php echo $input_name; ?>[]" class="form-control" disabled='disabled'>
					 <?php
				...
				<td><input type="number" class="form-control required-field webshop-price" onkeypress="return isNumberKey(event);" name="variant_webshop_price[]"  id="variant_webshop_price_<?php echo $random_id; ?>" value="<?php echo $variant['webshop_price']; ?>"  readonly  ></td>
				  ...
				  <input type="text" name="variant_sku[]" onblur="skudbcompare(this,<?php echo $variant['id']; ?>);"  class="form-control required-field unique-sku valid-sku" value="<?php echo $variant['sku']; ?>" placeholder="Enter Value" readonly></td>
