<div class="main-inner">
	<div class="add-bulk-inner2  ">
		<h1 class="head-name">Upload Updated CSV <a class="float-right" href="#" onclick="DownloadProductAttributestemplate_to_import();">Sample CSV</a></h1>
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="add-bulk-inner2-form">
			 ...
			 <div class="download-discard-small">
				...
				<button class="download-btn"  type="button" name="check_data" id="check_data" disabled="" onclick="CheckupdateCSVAttributesData();">Check Data</button>
				<button class="download-btn d-none"  type="button" name="bulk_upload" id="bulk_upload" onclick="UpdateProductsAttributes();">Upload</button>
			 </div>
		 </form>
	 </div>
	<!-- add-bulk-inner2 -->
