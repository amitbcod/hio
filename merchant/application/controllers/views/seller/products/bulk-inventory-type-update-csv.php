<div class="main-inner">
	<div class="add-bulk-inner2  ">
		<h1 class="head-name">Upload Updated CSV <a class="float-right" href="<?php echo SKIN_URL; ?>uploads/sample/Product_Inventory_types_import.csv"  target="_blank">Sample CSV</a></h1>
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="add-bulk-inner2-form">
			 ...
			 <div class="download-discard-small">
				...
				<button class="download-btn"  type="button" name="check_data" id="check_data" disabled="" onclick="CheckupdateCSVData_Inv_type();">Check Data</button>
				<button class="download-btn d-none"  type="button" name="bulk_upload" id="bulk_upload" onclick="UpdateProductsInv_type();">Upload</button>
			 </div>
		 </form>
	 </div>
	<!-- add-bulk-inner2 -->
