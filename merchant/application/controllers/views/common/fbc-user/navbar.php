 ...
 <nav class="navbar sticky-top flex-md-nowrap p-0">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="<?php echo base_url();?>dashboard" style="font-size: 27px;
    font-weight: 600;
    letter-spacing: 1px; color:#b20b1d;">INDIAMAGS</a>
  ...
  <div class="d-flex top-right right-nav-top">
    ...
    <a href="<?php echo base_url();?>PublisherController/editPublisher/<?php echo $_SESSION["LoginID"];?>"> <div class="d-flex align-items-center"><span class="pro-name"><?php echo $FBCData->email;?></span><i class="fa fa-user"></i> </div></a>
    </div>
