            ...
            <div class="row">           
                <div class="right-form-sec">          
                  <div class="col-sm-6 customize-add-inner-sec ">         
                    ...
                    <input class="form-control" type="text" id="first_name" required   name="first_name" value="<?php if(isset($customer_address->first_name)) { echo $customer_address->first_name ; }   ?>" placeholder="">  
                  </div>
                 <div class="col-sm-6 customize-add-inner-sec ">         
                    <label>Address Line 1</label>            
                    <input class="form-control" type="text" id="address_line1"  name="address_line1" value="<?php if(isset($customer_address->address_line1)) { echo $customer_address->address_line1 ; }   ?>" placeholder="">  
                  </div>  
                  <div class="col-sm-6 customize-add-inner-sec ">         
                    <label>City</label>            
              ...
              <?php } ?>
                   ...
                   <div class="col-sm-6 customize-add-inner-sec ">         
                    ...
                    <input class="form-control" type="text" id="mobile_no"   name="mobile_no" value="<?php if(isset($customer_address->mobile_no)) { echo $customer_address->mobile_no ; }   ?>" placeholder="">  
                  </div>      
                </div>  
                ...
                <div class="left-form-sec">
                  <div class="col-sm-6 customize-add-inner-sec ">         
                    ...
                    <input class="form-control" type="text" id="last_name" required   name="last_name" value="<?php if(isset($customer_address->last_name)) { echo $customer_address->last_name ; }   ?>" placeholder="">  
                  </div>  
                  <div class="col-sm-6 customize-add-inner-sec ">         
                    <label>Address Line 2</label>            
                    <input class="form-control" type="text" id="address_line2"  name="address_line2" value="<?php if(isset($customer_address->address_line2)) { echo $customer_address->address_line2 ; }   ?>" placeholder="">  
                  </div>  
                  <div class="col-sm-6 customize-add-inner-sec ">         
                    <label>Pincode</label>            
                    <input class="form-control" type="text" id="pincode"  name="pincode" value="<?php if(isset($customer_address->pincode)) { echo $customer_address->pincode ; }   ?>" placeholder="">  
                  </div>                                    
                  <div class="col-sm-6 customize-add-inner-sec ">
                    <label>State</label> 
