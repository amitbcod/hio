  ...
  public function insertData($table,$data)
  {
	...
	public function getOrderStatusLabel($id) {
        ...
        if ($id == '0') {
            ...
            $label = '<span class="tracking-missing">Tracking Missing</span>';
        } else if ($id == '5') {
            $label = '<span class="tracking-incomplete">Tracking Incomplete</span>';
        } else if ($id == '6') {
			$label = '<span class="tracking-complete">Tracking Complete</span>';
	...
	public function getOrderShipmentLabel($id) {
        ...
        if ($id == '1') {
            ...
            $label = '<a class="link-purple">Dropship</a>';
        }
        return $label;
    }
