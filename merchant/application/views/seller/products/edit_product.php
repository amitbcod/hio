	...
	<input type="hidden" value="<?php echo $ProductData->id; ?>" id="pid" name="pid">
		...
		<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="col-sm-12"><input type="text" class="form-control" name="product_name" value="<?php  echo $ProductData->name; ?>" id="product_name" placeholder="Product Name">

					</div>



					<div class="col-sm-12"><input type="text" class="form-control" name="product_code" id="product_code"  value="<?php  echo $ProductData->product_code; ?>" placeholder="Product Code *">
		...
		<div class="col-md-6">
			...
			<div class="container col-sm-12">
  				...
  				<form>
    				...
    				<label class="radio-inline">
      					...
      					<input type="radio" name="type-of-commission" <?php echo ($ProductData->pub_com_per_type == 0) ? 'checked' : '' ?> value="0" disabled>Merchant Commission
			...
			<input type="text" class="form-control" name="pub_com_percentage" id="pub_com_percentage" placeholder="Merchant Commission Percentage" value="<?php echo (isset($ProductData->pub_com_percent) && $ProductData->pub_com_percent!='')?$ProductData->pub_com_percent:''; ?>" readonly = "true">
			...
			<div class="col-sm-12"><h2>Meta Description</h2><textarea class="form-control product-highlight-textarea " id="meta_description"  name="meta_description"><?php echo (isset($ProductData->meta_description) && $ProductData->meta_description!='')?$ProductData->meta_description:''; ?></textarea></div>
			...
			<?php if(!$disable_daily_deals_yes){ ?>
			...
			<div class="col-sm-12">
				...
				<select class="form-control" name="daily_deals" id="daily_deals"
					...
					<?php echo ($disable_daily_deals_yes) ? 'disabled' : ''; ?>>

					<option value="0" <?php echo ($ProductData->daily_deals == 0) ? 'selected' : ''; ?>>No</option>

					<option value="1" <?php echo ($ProductData->daily_deals == 1) ? 'selected' : ''; ?>>Yes</option>
				...
				<small>
					...
					Allowed: <?php echo $daily_deals_limit; ?> |

					Used: <?php echo $current_count; ?>
			...
			<?php if(!$disable_flash_sale_yes){ ?>
				...
				<div class="col-sm-12">
					...
					<select class="form-control" name="flash_sale" id="flash_sale"
						...
						<?php echo ($disable_flash_sale_yes) ? 'disabled' : ''; ?>>

						<option value="0" <?php echo ($ProductData->flash_sale == 0) ? 'selected' : ''; ?>>No</option>

						<option value="1" <?php echo ($ProductData->flash_sale == 1) ? 'selected' : ''; ?>>Yes</option>
					...
					<small>
						...
						Allowed: <?php echo $flash_sale_limit; ?> |

						Used: <?php echo $current_flash_count; ?>
					...
					<small>
						...
						if (!empty($flash_sale_reasons)) {

							foreach ($flash_sale_reasons as $reason) {

								if ($reason) echo $reason . '<br>';
            ...
            <div class="col-sm-12">
                    ...
                    <div class="radio">
                        ...
                        <label>
							...
							<input type="radio" name="status" <?php echo (isset($ProductData->status) && $ProductData->status =='1')?'checked':''; ?> value="1">
                    ...
                    <div class="radio">
                        ...
                        <label>
							...
							<input type="radio" name="status"  <?php echo (isset($ProductData->status) && $ProductData->status =='2')?'checked':''; ?> value="2">
		...
		<div class="col-sm-12">
		 ...
		 <div class="col-md-6">
                ...
                <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" id="estimate_delivery_time" name="estimate_delivery_time" placeholder="Estimate Delivery Time" value="<?php echo (isset($ProductData->estimate_delivery_time) && $ProductData->estimate_delivery_time!='')?$ProductData->estimate_delivery_time:''; ?>" readonly="true"><span class="days-span">Days</span>
