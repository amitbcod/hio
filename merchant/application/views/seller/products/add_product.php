	...
	<input type="hidden" name="default_vat_percentage"  id="default_vat_percentage"  value="<?php echo $publication['default_vat_percentage'];?>" >
		...
		<h2>Product Details</h2>
			...
			<div class="col-sm-12">
				...
				<input type="text" class="form-control" name="langTitle" id="langTitle" placeholder="" maxlength='500'>
			</div>
			<div class="row">
		 ...
		 <div class="col-md-6">
			...
			<div class="container col-sm-12">
  				<form>
					...
					<input type="radio" name="type-of-commission" value="0" checked disabled>Merchant Commission
					<span class="checkmark" ></span></label>

					<label class="radio-inline">
					<input type="radio" name="type-of-commission" value="1" disabled>Product Commission
					<span class="checkmark" ></span></label>
  				</form>
			</div>
			...
			<div class="col-sm-12">
				...
				<input type="text" class="form-control" name="pub_com_percentage" id="pub_com_percentage" placeholder="Merchant Commission Percentage" value="<?php echo (isset($publication['commision_percent']) && $publication['commision_percent']!='')?$publication['commision_percent']:''; ?>" readonly = "true">
			</div>
