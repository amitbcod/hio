		...
		<!-- comment -->
			...
			<tr>
				<td valign="middle" align="center" style="padding:10px 0 0px 0">
					<?php
						if($invoice_logo_value=='yes' && isset($user_web_shop_details['site_logo'])){
							$site_logo = $this->encryption->decrypt($user_web_shop_details['site_logo']);
					?>
					 <a href="" style="color:#000000" target="_blank" >
						<img width="" style="max-height:65px;" alt="" border="0" src="<?=base_url()?>shop<?=$shop_id?>/uploads/<?=$site_logo?>" class="CToWUd">
					</a>
					<?php 
						}
