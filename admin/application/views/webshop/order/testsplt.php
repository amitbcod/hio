                    ...
                    <table class="table table-bordered table-style" id="DataTables_Table_WebshopOrders">
                        <thead>
                            <tr>
                                <th>Order Number </th>
                                <th>Split Data</th>
                                <th>Whuso Commision</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if (isset($split_data_list) && is_array($split_data_list)) {
                                foreach ($split_data_list as $order_id => $val_key) {
                            ?>
                                    <tr>
                                        <td><?php echo $order_id; ?></td>
                                        <td><?php echo $val_key[0]; ?></td>
                                        <td><?php echo $val_key[1]; ?></td>
                                    </tr>
                            <?php
                                }
                            }
