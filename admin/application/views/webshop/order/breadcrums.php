<div class="inner-nav">
	<ul class="nav nav-pills">
		<li
			class="<?php echo (isset($current_tab) && ($current_tab == 'orders' || $current_tab == 'order')) ? 'active' : ''; ?>">
			<a href="<?php echo base_url() ?>webshop/orders/">B2C Orders</a></li>
		...
		<li
			class="<?php echo (isset($current_tab) && ($current_tab == 'b2b-orders' || $current_tab == 'b2b-order')) ? 'active' : ''; ?>">
			<a href="<?php echo base_url() ?>webshop/b2b-orders/">B2B Orders</a>
		</li>
		<li
			class="<?php echo (isset($current_tab) && ($current_tab == 'pickup-orders' || $current_tab == 'pickup-order')) ? 'active' : ''; ?>">
			<a href="<?php echo base_url() ?>webshop/pickup-orders/">Pickup Orders</a>
		</li>
		<li
			class="<?php echo (isset($current_tab) && ($current_tab == 'deliveries' || $current_tab == 'deliveries')) ? 'active' : ''; ?>">
			<a href="<?php echo base_url() ?>webshop/deliveries/">Delivery Orders</a>
		</li>
		<li
			class="<?php echo (isset($current_tab) && ($current_tab == 'complete-orders' || $current_tab == 'complete-order')) ? 'active' : ''; ?>">
			<a href="<?php echo base_url() ?>webshop/complete-orders/">Complete Orders</a>
		</li>
		...
		<li
			...
			<a href="<?php echo base_url() ?>webshop/cancel-orders/">Cancel Orders</a>
		</li>
	</ul>
