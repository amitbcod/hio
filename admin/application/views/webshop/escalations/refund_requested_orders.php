...
<main role="main" class="main-box col-md-9 ml-sm-auto col-lg-10 px-md-4 dashboard-page">
	...
	<div class="tab-content"  >
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
          <h1 class="head-name">Request Refund Orders </h1> 
        ...
        <div class="content-main form-dashboard">
           <input type="hidden" id="current_tab" name="current_tab"  value="<?php //echo $current_tab; ?>">
              <div class="table-responsive text-center">
                <table class="table table-bordered table-style" id="DataTables_Table_WebshopRefundOrdersR">
                  <thead>
                    <tr>
                      <th>Order Number </th>
                      <th>Purchased On </th>
...
<script type="text/javascript" src="<?php echo SKIN_JS; ?>webshop_refund_requested_order_list.js"></script>
