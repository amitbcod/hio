	...
	<div class="tab-content">
		<div id="new-orders" class="tab-pane fade in active min-height-480  common-tab-section admin-shop-details-table" style="opacity:1;">
			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
				<h1 class="head-name"> <?php if($current_tab == 'pickup-orders'){ ?>B2B Pickup Details <?php } else if ($current_tab == 'delivery-orders'){ ?>B2B Delivery Details <?php } else { ?>B2B Orders Details <?php } ?> </h1>
