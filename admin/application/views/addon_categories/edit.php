...
<div class="main-inner">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        <h1 class="head-name">Edit Addon Category</h1>
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control">
                    <option value="1" <?= set_value('status', $category->status) == 1 ? 'selected' : ''; ?>>Active</option>
                    <option value="0" <?= set_value('status', $category->status) == 0 ? 'selected' : ''; ?>>Inactive</option>
                </select>
            </div>
