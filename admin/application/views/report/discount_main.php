...
<main role="main" class="main-box col-md-9 ml-sm-auto col-lg-10 px-md-4 dashboard-page">
	...
	<div class="tab-content"  >
      ...
      <!-- form -->
        <form id="salesListForm" name="salesListForm" method="POST" action="<?php echo base_url('ReportController/postGenerateDiscount') ?>" enctype="multipart/form-data">
          ...
          ?>
            ...
            <div class="row col-sm-12">
                <button class="purple-btn" type="submit" id="generateSaleDiscount" name="generateReport" >Generate Report</button>
            </div>
        </form>
        <!--end form-->
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
          <h1 class="head-name">Discount List</h1>
        <div class="float-right product-filter-div">
          <div class="search-div">
            <input class="form-control form-control-dark top-search" id="search_discount_term" name="search_discount_term" type="text" placeholder="Search for Discount" aria-label="Search">
        ...
        <div class="content-main form-dashboard">
          <div class="table-responsive text-center" id="reviewDiscountListBlock">
...
<script type="text/javascript" src="<?php echo SKIN_JS; ?>coupon_list.js?v=<?php echo CSSJS_VERSION; ?>"></script>

<script type="text/javascript">

  $(document).ready(function() {
      $("#generateSaleDiscount").click(function(){
          $('.danger').html('');
      }); 
  });
