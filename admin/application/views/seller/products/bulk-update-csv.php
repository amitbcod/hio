		...
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="add-bulk-inner2-form">
			 ...
			 <div class="download-discard-small">
				...
				<button class="download-btn"  type="button" name="check_data" id="check_data" disabled="" onclick="CheckupdateCSVData();">Check Data</button>
				<button class="download-btn d-none"  type="button" name="bulk_upload" id="bulk_upload" onclick="UpdateProducts();">Upload</button>
			 </div>
		 </form>
	 </div>
	<!-- add-bulk-inner2 -->
