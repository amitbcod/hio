zzzzzzzzzzz<?php $this->load->view('common/fbc-user/header'); ?>
				...
				<div class="product-details-block">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="col-sm-12"><input type="text" class="form-control" name="product_name" id="product_name" placeholder="Product Name *" maxlength='500'></div>
									...
									<?php if (isset($publication) && !empty($publication)) {
										...
										foreach ($publication as $pub) : 
											...
											if ($pub->vendor_name != "") { ?>
												...
												<option value="<?php echo $pub->id ?>" data-vat="<?php echo $pub->default_vat_percentage ?>">
