...
class B2BOrdersController extends CI_Controller
{
	...
	function loadordersajax()
	{
		...
		$ProductData = $this->B2BOrdersModel->get_datatables_orders($price, $order_status, $shipment_type, $fromDate, $toDate, $payment_method);
	...
	function PaymentDone()
	{
		...
		if (isset($_POST['id'])) {
			...
			if ($PublisherPaymentData) {
				...
				// $cc_emails = 'ronika@indiamags.cozm'; //$owner_email;
