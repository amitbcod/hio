...
class Ajax_pagination
{
    ...
    public $full_tag_open   = '<div class="paging-main"><ul class="pagination">';
    ...
    public $cur_tag_open    = '<li class="page-item active"><a href="javascript:void(0)" class="page-link">';
    ...
    public function initialize($params = array())
    {
        ...
        if ($this->anchor_class != '') {
            $this->anchor_class = 'class="page-link ' . $this->anchor_class . '" ';
        }
    }
    ...
    public function create_links()
    {
        ...
        if (($this->cur_page + $this->num_links) < $num_pages) {
            ...
            $output .= $this->last_tag_open . $this->getAJAXlink($i, $this->last_link, $num_pages) . $this->last_tag_close;
        }
    ...
    public function getAJAXlink($count, $text, $num_pages = '')
    {
        ...
        $linkpath = $this->link_func . '(' . $pageCount . ')';
        if ($num_pages != '') {
            $linkpath = $this->link_func . '(' . $pageCount . ',\'\',' . $num_pages . ')';
        }
        return '<li class="page-item"><a href="javascript:void(0);" id="' . $id . '" ' . $this->anchor_class . ' onclick="' . $linkpath . '">' . $text . '</a></li>';
    }
}
