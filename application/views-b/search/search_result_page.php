    	...
    	<div class="col-md-12">
          	<div class="row">
				<div class="col-md-3 col-lg-3 ">
					<div class="filter-section">
						...
						<!-- <div class="filter-inner-section shop-for-filter">
							...
							<ul class="collapse" id="filterByShopFor" style="">
				...
				<div class="col-md-9 col-lg-9 ">
					<div class="search-result-block mb-10">
						<h5><?= lang('your_search_results_for') ?> "<?php echo $search_term; ?>" </h5>
						<?php if(isset($shop_flag_shop) && $shop_flag_shop == 2 && $search_term == 'NEW YEAR SALE') { ?>
							<p style="color: #ff0000"><?=lang('new_year_sale_msg')?></p>
						<?php } ?>
					...
					<div class="categories-top">
						<div class="right-sorting-option">
							...
							<div class="sort-by-cat view-option"> <?= lang('view') ?> <span class="grid-view icon-grid_on <?php echo ($current_viewmode=='grid-view')?'active':'' ?>"></span> <span class="list-view icon-menu <?php echo ($current_viewmode=='list-view')?'active':'' ?>"></span>
							</div> <!-- sort-by-cat -->
						...
						<input type="hidden" name="search-term" id="search-term" value="<?php echo $search_term; ?>">
						<input type="hidden" name="page_sort_type" id="page_sort_type" value="SearchListing">
					</div> <!-- categories-top -->
						...
						<div class="product-grid-listing-view" style="<?php echo ($current_viewmode=='grid-view')?'display:block;':'display:none;'?>">
							<ul>
								<?php foreach ($product_list->ProductList as $prod) {
									...
									(new ProductList())->productListData($prod,$prod_image,'SearchListing');
                                ?>
...
<script type="text/javascript" src="<?php echo SKIN_JS; ?>search_result_page.js?v=<?php echo CSSJS_VERSION; ?>"></script>
