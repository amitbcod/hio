                  ...
                  <div class="left-filter">
                     ...
                     <?php
                        if (!empty($product_list) && (isset($product_list->statusCode) && $product_list->statusCode == '200')) {
                           (new CatalogFilters('','featured',''))->render();
                        }
				         ?>
                  </div>
                  <!-- left-filter-->
...
<script type="text/javascript" src="<?php echo SKIN_JS; ?>newarrival_product_list.js?v=<?php echo CSSJS_VERSION; ?>"></script>
</body>
</html>
