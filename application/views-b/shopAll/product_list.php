	...
	<div class="container">
		<div class="breadcrum">
			<ul>
				...
				<li class="active"><?=lang('shop_all')?></li>
			</ul>
		</div>
	</div>
          	...
          	<div class="row">
				...
				<div class="col-md-9 col-lg-9 ">
					...
					<div class="categories-top">
						...
						<input type="hidden" name="page_sort_type" id="page_sort_type" value="AllProductsList">
					</div> <!-- categories-top -->
						...
						<div class="product-grid-listing-view" style="<?php echo ($current_viewmode=='grid-view')?'display:block;':'display:none;'?>">
							<ul>
								<?php foreach ($product_list->ProductList as $prod) {
									...
									(new ProductList())->productListData($prod,$prod_image,'AllProductsList');
                                ?>
...
<script type="text/javascript" src="<?php echo SKIN_JS; ?>shop_all_product.js?v=<?php echo CSSJS_VERSION; ?>"></script>
