<?php $this->load->view('common/header'); ?>
          ...
          <div class="row">
				...
				<div class="col-md-12 col-lg-12 ">
					<div class="wishlist-listing my-orders">
						<form name="return-form" id="return-form" method="POST" action="<?php echo base_url(); ?>MyGuestOrdersController/confirmReturn">
						...
						<div class="order-info">
							...
							<div class="refund-textarea-section">
								...
								<textarea class="refund-textarea"  id="reason_for_return" name="reason_for_return" placeholder="Message"   <?php echo ($OrderData->status==0 || $OrderData->status==1)?'':'readonly'; ?>><?php echo (isset($OrderData->reason_for_return)  && $OrderData->reason_for_return!='')?$OrderData->reason_for_return:''; ?></textarea>
							</div>
							<!-- refund-textarea -->
						...
						<ul class="cart-left-box-block order-return-listing">
							...
							<div class="cart-table-amount-total">
									...
									<?php if($OrderData->refund_status==1){ ?>
						                    <p class="grey-light-text final-order-amount"><?=lang('refund_approved')?><span class="amount-doller"><?php echo CURRENCY_TYPE; ?>  <?php echo number_format($OrderData->order_grandtotal_approved, 2); ?></span> 
						                    </p>
						...
						<div class="print-option-bottom">
							...
							<a class="blue-btn-order"  href="<?php echo base_url() ?>return-guest-order/print/<?php echo $OrderData->return_order_id; ?>" target="_blank"><?=lang('print')?> </a>
							<?php }  ?>
	...
	<script type="text/javascript" src="<?php echo SKIN_JS; ?>return_order_detail.js?v=<?php echo CSSJS_VERSION; ?>"></script>
  </body>
</html>