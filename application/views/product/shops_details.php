					...
					<div class="col-main">    
						...
						<div class="column main">
							...
							<p class="category-image">
								<img id="product-collection-image-1" alt="CsMarketplace Banner" height="100%" width="100%" src="./shop_details_files/company_banner1751634076.jpeg">
							</p>
						...
						<div class="block block-layered-nav">
							...
							<div class="block-content">
								<ul id="narrow-by-list2">
									<li>Delivery Policy
										<a href="http://localhost:8081/mu/pub/media/ced/csmaketplace/vendor/delivery_policy1751634076.pdf" target="_blank">
											<i class="fa fa-download fa-fw" style="margin-left : 46px;"></i>
										</a>
									</li>
									<li>Return Policy<a href="http://localhost:8081/mu/pub/media/ced/csmaketplace/vendor/return_policy1751634076.pdf" target="_blank"><i class="fa fa-download fa-fw" style="margin-left : 55px;"></i></a></li>
									<li>Refund Policy<a href="http://localhost:8081/mu/pub/media/ced/csmaketplace/vendor/refund_policy1751634076.pdf" target="_blank"><i class="fa fa-download fa-fw" style="margin-left : 53px;"></i></a></li>
								</ul>
							</div>
						</div>
						<div class="block block-layered-nav">
