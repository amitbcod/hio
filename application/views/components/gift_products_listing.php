...
<div class="owl-carousel <?php if ($section_title == 'INTERNATIONAL') {
                                echo "owl-carousel-gifts margin-bottom-40";
                            } else {
                                echo "owl-carousel2x owl-responsive-1200";
                            } ?> owl-theme owl-loaded">

    <?php foreach ($magazinngift_product->ProductWithGifts as $magazingift_prod) :
